...
//traer vehiculo
				...
				$consulta2 = "SELECT * FROM vehiculos WHERE id = $idVehiculo";
...
<?php 
		...
		$consulta = "SELECT * FROM clientes WHERE id = $propietario";
...
//traer factura
				$consulta5 = "SELECT * FROM facturas WHERE vehiculo = $idVehiculo";
...
<div id="tarjetaInformacion" class="card-details">
	<div class="img-contenido">
		...
		<div class="text-body">
		<b>vehiculo: <i><?php echo $vehiculo; ?></i></b><br>
		<b>Precio vehiculo: <i><?php echo $precio; ?></i></b><br>
